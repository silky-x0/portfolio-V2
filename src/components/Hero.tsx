      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <AnimatedText delay={0.2} className="mb-4">
            <p className="text-[#e5e5e5] text-lg sm:text-xl font-medium">Hello, I&apos;m {heroConfig.name}</p>
          </AnimatedText>
          ...
          <AnimatedText delay={0.6} className="mb-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl text-[#ffffff] font-light">{heroConfig.title}</h2>
          </AnimatedText>
